    ...
    <div class="mt-lg-5 mb-md-0 mt-5 mb-5 mx-auto">
        <div class="container">
            <div id="temel-egitimler" class="row egitim-row" data-aos="fade-up">
                ...
                <div class="col-12">
                    <a href="#" class="collapsed d-block w-100 p-2 float-left mb-3 egitim-box" data-toggle="collapse" data-target="#teknoloji-kamplari">
                        <i class="fas fa-university fa-3x mr-3 float-left"></i>
                        <span class="float-left mt-md-2 mt-0" style="font-size: 20px; margin-top: 9px;">
                ...
                <div class="col-12">
                    <a href="#" class="collapsed d-block w-100 p-2 float-left mb-3 egitim-box" data-toggle="collapse" data-target="#farkindalik">
                        <i class="fas fa-user fa-3x mr-4 float-left"></i>
                        <span class="float-left mt-md-2 mt-0" style="font-size: 20px; margin-top: 9px;">
            ...
            <div id="uzman-egitimler" class="row egitim-row" data-aos="fade-up">
                ...
                <div class="col-12 mt-5">
                    <h2 class="mb-3 float-left">Veritabanı Eğitimleri</h2>
                    <!-- Button trigger modal -->
                    <button type="button" class="btn btn-primary btn-lg btn-color-low float-right mb-3" data-toggle="modal" data-target="#modalCenter">
                        Eğitim Talep Formu
                    </button>
                ...
                <div class="col-12">
                    <a href="#" class="collapsed d-block w-100 p-2 float-left mb-3 egitim-box" data-toggle="collapse" data-target="#hvl-sql-101">
                        <i class="fas fa-database fa-3x mr-2 float-left"></i>
                        <span class="float-left mt-md-2 mt-0" style="font-size: 20px; margin-top: 9px;">
                    ...
                    <div class="collapse float-left w-100" style="margin-top:-1rem!important" id="hvl-sql-101" data-parent="#uzman-egitimler">
                        <div class="card card-body mb-3">
                            ...
                            <div class="card-content p-3 mt-4" style="background-color: rgba(0,0,0,0.05)">
                                <p class="mb-1">Bu eğitim aşağıdaki konuları içermektedir:</p>
                                <ul>
                                    <li>Kavramsal Veritabanı Modelleme</li>
                                    <li>Veri Tipleri</li>
                                    <li>Veri Tanımlama Dili (DML)</li>
                                    <li>Veri İşleme Dili (DDL)</li>
                                    <li>Veri Kontrol Dili</li>
                                    <li>Veritabanı Sorgulama(DCL)</li>
                                    <li>Temel Veritabanı Fonksiyonları</li>
                                    <li>Veritabanı Indexleri ve Sequence</li>
                ...
                <div class="collapse float-left w-100" style="margin-top:-1rem!important" id="hvl-sql-102" data-parent="#uzman-egitimler">
                    <div class="card card-body mb-3">
                        ...
                        <div class="card-content p-3 mt-4" style="background-color: rgba(0,0,0,0.05)">
                            ...
                            <ul>
                                <li>PL/SQL Giriş</li>
                                <li>PL/SQL Blok Yapısı</li>
                                <li>PLSQL Veri Atama</li>
                                <li>PLSQL Karakter Set</li>
                                <li>PL/SQL Veri Tipleri ve Değişkenler</li>
                                <li>PL/SQL Akış Operatörleri</li>
                                <li>Alt Programlar (Sub Program)</li>
                                <li>PROSEDÜRLER</li>
                                <li>Fonksiyonlar</li>
                                <li>RECURSIVE (Tekrarlayan) Fonksiyonlar</li>
                                <li>Trigger Kullanımı</li>
                                <li>ASSOCIATIVE Array (Index by Table)</li>
                                <li>VARRAY (Variable Size Array)</li>
                                <li>PL/SQL Koleksiyon Metodları</li>
                                <li>Aykırı Durumlar (Exception Handling)</li>
                                <li>DBMS OUTPUT</li>
                                <li>...</li>
                            </ul>
                            <div class="d-flex align-items-center float-left mr-5">
                ...
                <div class="collapse float-left w-100" style="margin-top:-1rem!important" id="hvl-pgsql-101" data-parent="#uzman-egitimler">
                    <div class="card card-body mb-3">
                        ...
                        <div class="card-content p-3 mt-4" style="background-color: rgba(0,0,0,0.05)">
                            <p class="mb-1">Bu eğitim aşağıdaki konuları içermektedir:</p>
                            <ul>
                                <li>Roller Kullanımı</li>
                                <li>Veri tabanları</li>
                                <li>MVCC</li>
                                <li>Tablolar</li>
                                <li>Sunucu izleme</li>
                                <li>Veri yedekleme</li>
                                <li>Kısıtlayıcılar (constraints)</li>
                                <li>Veri türleri</li>
                                <li>Sorgu Planlama</li>
                                <li>JIT</li>
                            </ul>
                            <div class="d-flex align-items-center float-left mr-5">
                                <svg style="width: 48px; height: 48px;" class="d-md-block d-none float-left mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                    ...
                    <div class="collapse float-left w-100" style="margin-top:-1rem!important" id="hvl-pgsql-102" data-parent="#uzman-egitimler">
                        <div class="card card-body mb-3">
                            ...
                            <div class="card-content p-3 mt-4" style="background-color: rgba(0,0,0,0.05)">
                                <p class="mb-1">Bu eğitim aşağıdaki konuları içermektedir:</p>
                                <ul>
                                    <li>Yalıtım (isolation)</li>
                                    <li>Tablo seviyesinde kilitler (table-level locks)</li>
                                    <li>Satır seviyesinde kilitler (table-level locks)</li>
                                    <li>Deadlock</li>
                                    <li>İşlemleri sırayla çalıştırma</li>
                ...
                <div class="collapse float-left w-100" style="margin-top:-1rem!important" id="hvl-pgadm-201" data-parent="#uzman-egitimler">
                    <div class="card card-body mb-3">
                        ...
                        <div class="card-content p-3 mt-4" style="background-color: rgba(0,0,0,0.05)">
                            <p class="mb-1">Bu eğitim aşağıdaki konuları içermektedir:</p>
                            <ul>
                                <li>Postgresql INDEX Yönetimi</li>
                ...
                <div class="collapse float-left w-100" style="margin-top:-1rem!important" id="hvl-pgadm-202" data-parent="#uzman-egitimler">
                    <div class="card card-body mb-3">
                        ...
                        <div class="card-content p-3 mt-4" style="background-color: rgba(0,0,0,0.05)">
                            <p class="mb-1">Bu eğitim aşağıdaki konuları içermektedir:</p>
                            <ul>
                                <li>PostgreSQL yedekleme stratejileri</li>
                                <li>Postgresql ile Yüksek Erişilebilirlik - Patroni</li>
                ...
                <div class="col-12 mt-5">
                    <h2 class="mb-3 float-left">Big Data ve Sistem Yönetimi Eğitimleri</h2>
                    <button type="button" class="btn btn-primary btn-lg btn-color-low float-right mb-3" data-toggle="modal" data-target="#modalCenter">
                        Eğitim Talep Formu
                    </button>
                </div>
                ...
                <div class="collapse float-left w-100" style="margin-top:-1rem!important" id="hvl-bgd-101" data-parent="#uzman-egitimler">
                    <div class="card card-body mb-3">
                        ...
                        <div class="card-content p-3 mt-4" style="background-color: rgba(0,0,0,0.05)">
                            <p class="mb-1">Bu eğitim aşağıdaki konuları içermektedir:</p>
                            <ul>
                                <li>Big Data Temelleri</li>
                                <li>Hadoop Mimarisi</li>
                                <li>HDFS Mimarisi 1 - Datanode ve NameNode Kavramları</li>
                                <li>HDFS Mimarisi 2- Replication ve Okuma Yazma İşlemleri</li>
                                <li>MapReduce Mimarisi</li>
                                <li>Apache YARN Mimarisi</li>
                                <li>Big Data Platformları</li>
                                <li>Ambari Kurulumu</li>
                                <li>Cloudera Nedir</li>
                                <li>Cloudera Manager Kurulumu</li>
                ...
                <div class="collapse float-left w-100" style="margin-top:-1rem!important" id="hvl-bgd-102" data-parent="#uzman-egitimler">
                    <div class="card card-body mb-3">
                        ...
                        <div class="card-content p-3 mt-4" style="background-color: rgba(0,0,0,0.05)">
                            <p class="mb-1">Bu eğitim aşağıdaki konuları içermektedir:</p>
                            <ul>
                                <li>Big Data ile Sorgulama İşlemleri</li>
                                <li>Apache Hive Nedir</li>
                                <li>Hive Yönetimsel İşlemler</li>
                                <li>Presto Nedir ve Kurulumu</li>
                                <li>Apache Sqoop Nedir</li>
                                <li>Apache Kafka</li>
                                <li>Centos üzerine Hbase Kurulumu</li>
                                <li>Cassandra Veri Tabanı Mimarisi & Kurulumu</li>
                                <li>Mongo Veri Tabanı</li>
                ...
                <div class="collapse float-left w-100" style="margin-top:-1rem!important" id="hvl-aky-101" data-parent="#uzman-egitimler">
                    <div class="card card-body mb-3">
                        ...
                        <div class="card-content p-3 mt-4" style="background-color: rgba(0,0,0,0.05)">
                            <p class="mb-1">Bu eğitim aşağıdaki konuları içermektedir:</p>
                            <ul>
                                <li>Python'a giriş</li>
                                <li>Kabuk üzerinden kullanımı</li>
                                <li>Editör seçimi</li>
                                <li>Python paket sistemi</li>
                                <li>Veri tipleri ve dönüşümler</li>
                                <li>Dosya işlemleri</li>
                                <li>Karakterler ve sayılarla işlemler</li>
                                <li>Listeler, Demetler, Sözlükler ve Kümeler</li>
                                <li>Döngüler ve hata yakalama</li>
                                <li>Aktif kullanılan modüller</li>
                                <li>Python ile veritabanı işlemleri</li>
                ...
                <div class="collapse float-left w-100" style="margin-top:-1rem!important" id="hvl-kub-101" data-parent="#uzman-egitimler">
                    <div class="card card-body mb-3">
                        ...
                        <div class="card-content p-3 mt-4" style="background-color: rgba(0,0,0,0.05)">
                            <p class="mb-1">Bu eğitim aşağıdaki konuları içermektedir:</p>
                            <ul>
                                <li>Docker Kurulum</li>
                                <li>Container Teknolojisi Nedir ?</li>
                                <li>Dockerfile ve Image</li>
                                <li>Container İçinde Komut Çalıştırmak</li>
                                <li>Docker Volume Yapısı</li>
                                <li>Kubernetes Nedir ?</li>
                                <li>Kubernetes Bileşenleri</li>
                                <li>Kubernetes Objeleri</li>
                                <li>Minikube ile Kubernetes</li>
                                <li>Uygulamalar</li>
                            </ul>
                            <div class="d-flex align-items-center float-left mr-5">
                                <svg style="width: 48px; height: 48px;" class="d-md-block d-none float-left mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                ...
                <div class="collapse float-left w-100" style="margin-top:-1rem!important" id="hvl-cep-101" data-parent="#uzman-egitimler">
                    <div class="card card-body mb-3">
                        ...
                        <div class="card-content p-3 mt-4" style="background-color: rgba(0,0,0,0.05)">
                            ...
                            <ul>
                                <li>CEPH Mimarisi</li>
                                <li>Çekirdek Bileşenleri</li>
                                <li>Ortam kurulumu</li>
                                <li>DEPH Cluster Kurulumu</li>
                                <li>CephFS + NFS-Ganesha</li>
                                <li>Object Depolama</li>
                                <li>Block Depolama</li>
                                <li>Crush Map Yapısı</li>
                                <li>CEPHADM</li>
                                <li>RBD Yönetimi</li>
                                <li>RGW Kurulumu</li>
                                <li>CEPH FS Yönetimi</li>
                                <li>CEPH Ansible</li>
                ...
                <div class="collapse float-left w-100" style="margin-top:-1rem!important" id="hvl-zab-101" data-parent="#uzman-egitimler">
                    <div class="card card-body mb-3">
                        ...
                        <div class="card-content p-3 mt-4" style="background-color: rgba(0,0,0,0.05)">
                            <p class="mb-1">Bu eğitim aşağıdaki konuları içermektedir:</p>
                            <ul>
                                <li>Zabbix Hakkında</li>
                                <li>Zabbix Kurulumu ve Ajan yapısı</li>
                                <li>Zabbix Yapılandırmaları</li>
                                <li>Sistem İzleme</li>
                                <li>Veritabanı İzleme</li>
                                <li>SNMP Testleri</li>
                                <li>Sunucu için Yapılandırmalar</li>
                                <li>İzleme ve Alarm yapısı</li>
                                <li>Panel Yönetimi</li>
